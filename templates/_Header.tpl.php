...
<html lang="en">
	<head>
		...
		<title>LENO MOTOS</title>
		<meta name="viewport" content="width=device-width, initial-scale=1.0" />
		<meta name="description" content="SISSTC" />
			...
			<div class="navbar navbar-inverse navbar-fixed-top">
				<div class="navbar-inner">
					<div class="container">
						...
						<a class="brand" href="./">Leno Motos</a>
						<div class="nav-collapse collapse">
							<ul class="nav">
								<li <?php if ($this->nav=='clientes') { echo 'class="active"'; } ?>><a href="./clientes">Clientes</a></li>
								<li <?php if ($this->nav=='compras') { echo 'class="active"'; } ?>><a href="./compras">Compras</a></li>
								<li <?php if ($this->nav=='pagamentos') { echo 'class="active"'; } ?>><a href="./pagamentos">Pagamentos</a></li>
